...
const Header = ({ currentUser = null, handleLogout = () => {}}) => {
    ...
    return (
        <div>
            <header style={{background: colors.blue400, color: colors.white, display: 'flex', alignItems: 'center', padding: 17}}>
                <div style={{flexGrow: 1}}><h1 style={{margin: 0, padding: 0}}>Would You Rather</h1></div>
                <div style={{padding: "0 17px"}}><h3>{`Hi ${currentUser ? currentUser.name : 'Guest'}`}</h3></div>
